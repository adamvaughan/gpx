class App.Views.DurationSummaryView extends Backbone.View
  className: 'duration-summary-view'

  render: =>
    $(@el).html JST['duration_summary_view']([])
    ...
    chartView = new App.Views.MonthlyDurationChartView(collection: @collection)
    chartView.render()
  ...
  changeChartView: (event) =>
    ...
    if activeChartView != selectedChartView
      ...
      if selectedChartView == 'year'
        chartView = new App.Views.AnnualDurationChartView(collection: @collection)
        chartView.render()
      else
        chartView = new App.Views.MonthlyDurationChartView(collection: @collection)
        chartView.render()
